...
All 23 backlog rows have corresponding `tasks/<id>.json` files. Generated by `elyos/task-decomposition` on 2026-06-29. Validation: all 23 pass the Elyos schema harness (exit 0).

| File | Milestone | Type | Risk | Status |
|---|---|---|---|---|
| [incidence-explorers-governance-001.json](tasks/incidence-explorers-governance-001.json) | M0 | design-spec | medium | open |
| [incidence-explorers-site-002.json](tasks/incidence-explorers-site-002.json) | M0 | research | medium | open |
| [incidence-explorers-repo-003.json](tasks/incidence-explorers-repo-003.json) | M0 | code | low | open |
| [incidence-explorers-stats-spec-004.json](tasks/incidence-explorers-stats-spec-004.json) | M0 | design-spec | medium | open |
| [incidence-explorers-suppression-005.json](tasks/incidence-explorers-suppression-005.json) | M0 | code | medium | open |
| [incidence-explorers-license-006.json](tasks/incidence-explorers-license-006.json) | M1 | research | medium | open |
| [incidence-explorers-ingest-007.json](tasks/incidence-explorers-ingest-007.json) | M1 | data | medium | open |
| [incidence-explorers-validate-008.json](tasks/incidence-explorers-validate-008.json) | M1 | code | medium | open |
| [incidence-explorers-stats-009.json](tasks/incidence-explorers-stats-009.json) | M2 | code | medium | open |
| [incidence-explorers-dashboard-010.json](tasks/incidence-explorers-dashboard-010.json) | M2 | code | medium | open |
| [incidence-explorers-eval-011.json](tasks/incidence-explorers-eval-011.json) | M2 | code | medium | open |
| [incidence-explorers-literacy-012.json](tasks/incidence-explorers-literacy-012.json) | M3 | writing | medium | open |
| [incidence-explorers-explainer-013.json](tasks/incidence-explorers-explainer-013.json) | M3 | writing | high | open |
| [incidence-explorers-helplines-014.json](tasks/incidence-explorers-helplines-014.json) | M3 | data | high | open |
| [incidence-explorers-readiness-015.json](tasks/incidence-explorers-readiness-015.json) | M4 | code | medium | open |
| [incidence-explorers-partner-016.json](tasks/incidence-explorers-partner-016.json) | M5 | research | high | open |
| [incidence-explorers-handoff-017.json](tasks/incidence-explorers-handoff-017.json) | M5 | maintenance | high | open |
| [incidence-explorers-ops-018.json](tasks/incidence-explorers-ops-018.json) | M6 | maintenance | medium | open |
| [incidence-explorers-site2-019.json](tasks/incidence-explorers-site2-019.json) | Backlog | writing | high | open |
| [incidence-explorers-i18n-020.json](tasks/incidence-explorers-i18n-020.json) | Backlog | writing | high | open |
| [incidence-explorers-disparities-021.json](tasks/incidence-explorers-disparities-021.json) | Backlog | data | high | open |
| [incidence-explorers-trends-022.json](tasks/incidence-explorers-trends-022.json) | Backlog | code | medium | open |
| [incidence-explorers-datasheets-023.json](tasks/incidence-explorers-datasheets-023.json) | Backlog | data | medium | open |

Fan-out: none — all IDs are explicitly enumerated in TASKS.md; no fabrication.
